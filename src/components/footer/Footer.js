  ...
  return (
    <div className='footer'>
        <div className='container'>
            <p className='title-text'>CHHUT Pech</p>
            <p className='normal-text' style={{color:"white"}}>Lisque persius interesset his et, in quot quidam 
                persequeris vim, ad mea essent possim iriure.Lisque persius interesset his et, in quot quidam 
                persequeris vim, ad mea essent possim iriure.Lisque persius interesset his et, in quot quidam 
            ...
            <div className='footer-follow'>
              ...
              <a href='https://t.me/chhutpech' target="_blank">
                  <svg cla width="20" height="20" viewBox="0 0 24 24">
              ...
              <a href='https://www.tiktok.com/@coding_kh?lang=en' target="_blank">
                  <svg width="20" height="20" viewBox="0 0 24 24">
        ...
        <div className='copyright'>Copyright ©2022 CHHUT Pech. </div>
    </div>
  )
}
